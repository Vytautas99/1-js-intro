...
function multiply(a, b) {
    ...
    if (isNaN(a)) {
        return 'pirmasis paramentras nera normalus skaicius'

    } //if (isFinite(b) === false) {
        //return 'antrasis paramentras nera normalus skaicius'
    //} 
    if ('' + b === 'NaN') {
        return 'antrasis paramentras nera normalus skaicius' 
     ...
     if (a === Infinity || a === -Infinity) {
        return 'pirmasis parametras neagali buti begalybe'

    } 

    if (b === Infinity || b === -Infinity) {
        return 'antrasis parametras neagali buti begalybe'
    }
